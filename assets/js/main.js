...
(function ($) {
    ...
    $('[data-countdown]').each(function () {
        ...
        $this.countdown(finalDate, function (event) {
            $this.html(event.strftime('<ul class="counter timer clearfix"><li class="ht-count days"><span id="day" class="digit days">%-D</span> <span class="smalltext">Dias</span></li> <li class="ht-count hour"><span id="hour" class="digit hours">%-H</span> <span class="smalltext">Hrs</span></li> <li class="ht-count minutes"><span id="minute" class="digit minutes">%M</span> <span class="smalltext">Min</span></li> <li class="ht-count second"><span id="second" class="digit seconds">%S</span> <span class="smalltext">Sec</span></li></ul>'));
        });
    });
